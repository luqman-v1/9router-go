...
func TestEstimateAnthropicTokens(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got := estimateAnthropicTokens([]byte(tt.body))
			if got != tt.want {
				t.Errorf("estimateAnthropicTokens(%q) = %d, want %d", tt.body, got, tt.want)
			}
		})
	}
}
...
func TestCountValueChars(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got := countValueChars(tt.v)
			if got != tt.want {
				t.Errorf("countValueChars(%v) = %d, want %d", tt.v, got, tt.want)
			}
		})
	}
}
...
func TestMessageContentChars(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got := messageContentChars(tt.c)
			if got != tt.want {
				t.Errorf("messageContentChars(%v) = %d, want %d", tt.c, got, tt.want)
			}
		})
	}
}
...
func TestContentBlockChars(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got := contentBlockChars(tt.blk)
			if got != tt.want {
				t.Errorf("contentBlockChars(%v) = %d, want %d", tt.blk, got, tt.want)
			}
		})
	}
}
...
func TestHandleOllamaChat(t *testing.T) {
	...
	handler.HandleOllamaChat(rec, req)
